...
class AttendancePDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(30, 6, str(self.stats.get('Employees', 0)), border=0, align='L', ln=True)
        ...
        self.set_font('helvetica', '', 10)
        self.cell(30, 6, str(self.stats.get('TotalPunches', 0)), border=0, align='L', ln=True)
        ...
        self.set_font('helvetica', '', 10)
        self.cell(30, 6, str(self.alerts_count), border=0, align='L', ln=True)
...
# EXPORT FUNCTION
# ==========================================================
def export_pdf(transactions, daily, overall, statistics, alerts, ml_data=[]):
