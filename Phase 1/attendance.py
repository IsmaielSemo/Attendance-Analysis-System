...
def clean_records(records): #Removes consecutive IN/OUTs PER EMPLOYEE

    grouped = defaultdict(list)

    for r in records:
        grouped[r.BadgeID].append(r)

    cleaned = []

    for badge in grouped:
...
def employee_statistics(records, start_date=None, end_date=None): #Get some statistics about employee behaviors
